...
import { HooksAdvancedPres } from "./components/hooksadvancedpres.js";
...
<Notes>1) Read Priorities. 2) What do I say about CJC?</Notes>

---

# Hooks Release Date is February 4th!

<img width="100%" height="600px" src="./img/hooksreleasedate.png" />
...
<div style={{ fontSize: 60, textAlign: "left" }}>
  <ul>
    ...
    <li>Classes can be confusing.</li>
    <li>Duplicated logic.</li>
    <li>HOC, Classes, Render props ... oh my!!!.</li>
    <li>Lower barrier to entry for new devs.</li>
  </ul>
</div>
...
<img width="90%" height="600px" src="./img/captainhook.jpg" />
...
<img width="100%" height="500px" src="./img/count.png" />
...
<CodeSurfer 
  code={require("raw-loader!./snippets/advancedhook.snippet")} 
  lang="javascript"
  showNumbers={false}
  dark={true}
    steps={[
    { notes: "Example with multiple useState and useEffects" },
    { range: [6, 9], notes: "Multiple setState's." },
    { range: [16, 18], notes: "Add event listeners." },
    { range: [20, 22], notes: "Remember this replaces componentWillUnmount." },
    { range: [26, 30], notes: "OnMount status() get's ran 1 time. Why?" },
    { tokens: {30: [4, 5]}, notes: "What's the empty array for?" }, 
    { notes: "What's this look like as a class?" }
  ]}
  />;
