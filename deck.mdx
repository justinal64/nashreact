...
It can be a good alternative to redux when all your doing is passing data around. useContext
...
<Notes>
  ...
  theory should reduce the bundle size and make it a little more performant.
  Last Point) Tell story about what we are doing with our project at work.
  (Refactoring certain areas ... hitting the growing pains). If your at that
  point with your app use hooks when you refactor, but I wouldn't refactor a
  prod app just to use hooks.
</Notes>
